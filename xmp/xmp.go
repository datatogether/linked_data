...
// XMPDescription combines descriptive structs
...
type DublinCore struct {
	...
	// TODO - currently this is a string for straightforward storage
...
func (seq RDFSeq) DefaultString() string {
	return strings.Join(seq.Items.Items, "; ")
}

func (seq RDFSeq) String() string {
	if len(seq.Default()) == 0 {
		return ""
	}
